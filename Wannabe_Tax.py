...
import requests
import json
from utils import send_data_to_api, render_common_form, set_global_page_config # [NEW]
...
# 1. 배경: 총 자산
    ...
    if liquidity_crisis and crisis_year is not None:
        ...
        fig.add_annotation(
            ...
            ax=0, ay=-40, bgcolor="#0054FF", bordercolor="#FFFF00",
    ...
    fig.update_layout(
        ...
        yaxis=dict(title="금액 단위(억원)", fixedrange=True, tickformat=".1f", showgrid=True, gridcolor='#374151'),
        dragmode=False,
    )
...
def main():
    set_global_page_config(page_title="Wannabe Tax", icon_path="logo.png")
